...
<img src="https://latex.codecogs.com/gif.latex?\begin{equation}MRR@N&space;=&space;\frac{1}{K}&space;\sum_{i=1}^{K}&space;\frac{1}{\rho\left(\text&space;{&space;image&space;}&space;'i'\right)}\end{equation}" title="MRR@N">
