...
&#x1F535; This REPO is for finding a solution to an Image to article's Text matching problem using embeddings from CNN (VGG19, ResNet152V2, DenseNet201) and gensim Doc2Vec.
